...
import 'package:doaniot/features/auth/data/repositories/mock_auth_repository.dart';
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  void _handleSignUp() async {
    if (_formKey.currentState!.validate() && _agreedToTerms) {
      ...
      try {
        // Backend Friend: Call API register
        final user = await _authRepository.register("New User", _emailController.text, _passwordController.text);
