...
import aromaDiffuserImg from '../../assets/aroma_diffuser.png';
import acUnitImg from '../../assets/ac_unit.png';
import speakerImg from '../../assets/speaker.png';
import bedroomImg from '../../assets/bedroom.png';
// --- Mock Data ---
const devices = [
   { id: 1, name: 'Smart Lamp', room: 'Living Room', active: true, img: livingRoomImg },
   { id: 2, name: 'Aroma Diffuser', room: 'Living Room', active: true, img: aromaDiffuserImg },
   { id: 3, name: 'Speaker', room: 'Living Room', active: true, img: speakerImg },
   { id: 4, name: 'Speaker', room: 'Bedroom', active: false, img: speakerImg },
   { id: 5, name: 'Air Conditioner', room: 'Living Room', active: false, img: acUnitImg },
   { id: 6, name: 'Smart Lamp', room: 'Living Room', active: true, img: livingRoomImg },
];
