...
// --- Mock Data ---
const devices = [
   { id: 1, name: 'Smart Lamp', room: 'Living Room', active: false, img: livingRoomImg }, // img là từ assets
   { id: 2, name: 'Aroma Diffuser', room: 'Living Room', active: false, img: aromaDiffuserImg },
   { id: 3, name: 'Air Conditioner', room: 'Living Room', active: false, img: acUnitImg },
